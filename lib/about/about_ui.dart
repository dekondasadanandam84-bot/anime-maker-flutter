        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(color: Color(0xFF4C4546), fontSize: 16),
                    ),
                  ],
                ),
              ),
              ...
              Row(children: [_stat('ACTIVE DEVELOPERS', '1'), const SizedBox(width: 16), _stat('MODEL', 'Solo')]),
              const SizedBox(height: 16),
              Row(children: [_stat('STATUS', 'In Development'), const SizedBox(width: 16), _stat('VISION', 'Creative Ecosystem')]),
              const SizedBox(height: 96),
                  ...
                  children: [
                    Container(
                      ...
                      child: const Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 7),
                          Text('SOLO DEVELOPER', style: TextStyle(fontSize: 12)),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('TEAM STRUCTURE', style: TextStyle(fontSize: 14)),
                          const SizedBox(height: 16),
                          _title('No formal development team currently.'),
                          const SizedBox(height: 16),
                          _body(
              ...
              Center(child: _title('How It Was Developed')),
              const SizedBox(height: 15),
              Center(child: _body('The chronological evolution of the AnimeClip platform.')),
              const SizedBox(height: 48),

              _timeline('01', 'Initial Idea', 'Conceptualizing a unified platform for animation workflows.'),
              _timeline('02', 'Product & UI Design', 'Establishing the minimalist, studio-grade aesthetic and user experience.'),
              _timeline('03', 'Flutter Development', 'Building the core engine for cross-platform performance.'),
              _timeline('04', 'Application Architecture', 'Structuring data: Project > Season > Episode > Clip.'),
              _timeline('05', 'Animation Systems', 'Integrating precise timeline and playback controls.'),
              _timeline('06', 'Continuous Improvement', 'Iterative refinement based on internal testing and feedback.'),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _title('Why AnimeClip', color: Colors.white),
                    const SizedBox(height: 15),
                    _body(
              ...
              // Added support section for bugs and issues.
              Container(
                width: double.infinity,
