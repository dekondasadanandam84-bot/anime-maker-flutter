...
class _ClipsScreenState extends State<ClipsScreen> {
  ...
  // No episode, project, settings, IDs, or project name are
  // stored in this screen.
  // ============================================================
  ...
  Future<void> _createClip() async {
    final episode = projectController.currentEpisode;
    ...
    projectController.createCurrentClip(
      name: name,
    );
  }
  ...
  // Get the latest clip from ProjectController.
  final currentClip =
