...
BottomBarController get controller =>
widget.controller;

EditorResponsiveData get metrics =>
widget.metrics;
...
final showActions =
controller.handleFrameTap(frame);
...
void _duplicate() {
controller.duplicateFrames( <int>[
controller.selectedFrame,
],
);
...
class _FloatingFrameActionsToolbar
extends StatelessWidget {
