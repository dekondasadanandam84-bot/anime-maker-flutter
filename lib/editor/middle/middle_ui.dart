...
class MiddleUI extends StatelessWidget {
  const MiddleUI({super.key, required this.controller, required this.metrics});
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Container(
          ...
          child: Center(
            child: Padding(
              padding: EdgeInsets.all(metrics.canvasPadding),
              child: LayoutBuilder(
                builder: (context, constraints) {
                  final maxWidth = constraints.maxWidth;
                  final maxHeight = constraints.maxHeight;

                  final aspectRatio = controller.aspectRatio > 0
                  ...
                  final canvasWidth = widthFromHeight <= maxWidth
                      ? widthFromHeight
                      : maxWidth;
